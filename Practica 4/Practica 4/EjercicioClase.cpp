/*Practica 3
	se modificaba la piramide
	se usaba una piramide y se cambiaba el color de las caras
	de colocaba el color por cada cara
*/
...
para seleccionar el nodo padre se responde
¿cual es la parte con mas bojetos conectados?
¿de donde tomarias el objeto para moverlo?
en codigo cada bifurcacion del diagrama sera para crear una matriz que guardara las transformaciones geometricas temporalmente
...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//se usa modelaux2 porque se hereda de la cabina que es nuestro "origen" del modelo
		//Base
		model = modelaux2;
